...
from keras.layers import (BatchNormalization, Conv1D, Dense, Input, 
    TimeDistributed, Activation, Bidirectional, SimpleRNN, GRU, LSTM,CuDNNGRU)
...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    input_data = Input(name='the_input', shape=(None, input_dim))
    # the RNN 
    simple_rnn = GRU(units,return_sequences=True, name='rnn_1')(input_data)
    # doing Batch Normalization
    bn_rnn = BatchNormalization(name='bn_rnn_1')(simple_rnn)
    # TODO: Add recurrent layers, each with batch normalization    
    for layer in range(2,recur_layers+1) : 
        simple_rnn =GRU(units,return_sequences=True, name='rnn_%d'%layer)(bn_rnn)
        bn_rnn = BatchNormalization(name='bn_rnn_%d'%layer)(simple_rnn)
...
def final_model(units,input_dim, filters, kernel_size, conv_stride,
    ...
    # Add a recurrent layer
    bidir_rnn_1 = Bidirectional(GRU(output_dim, return_sequences=True, name='rnn_1',go_backwards=False))(bn_cnn)
    bn_rnn_1 = BatchNormalization(name='bn_rnn_1')(bidir_rnn_1)
    
    # layer 2
    bidir_rnn_2 = Bidirectional(GRU(output_dim, return_sequences=True, name='rnn_2'))(bn_rnn_1)
    bn_rnn_2 = BatchNormalization(name='bn_rnn_2')(bidir_rnn_2)
    
    
    #layer 3
    bidir_rnn_3 = Bidirectional(GRU(output_dim, return_sequences=True, name='rnn_3'))(bn_rnn_2)
